...
public class BrowserUtils {
    ...
    public static void waitForElementsToBeVisible(List<WebElement> elements, int timeout) {
    ...
    public static void verifyElementNotDisplayed(By by) {
        try {
            ...
            // Element is not found, which means it is not displayed. No need to assert failure.
            System.out.println("Element not found as expected: " + by);
        }
    }
